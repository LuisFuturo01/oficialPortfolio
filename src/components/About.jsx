            ...
            <div className="about-grid">
                <div className="about-text">
                    ...
                    <div className="about-actions">
                        <a href="https://drive.google.com/file/d/1i4QaSSfWKybM-HSPRRhoUBAaUrr9BJg2/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn-highlight large">
